...
def download_dataset():
    print("Downloading churn_prevention dataset from Hugging Face...")
    try:
        # Carica il dataset
        dataset = load_dataset("SINTON-IA/churn_prevention", split="train")
        ...
        file_path = os.path.join(data_dir, "churn_features.csv")
